...
if(isset($_POST['submit'] ))
{
	...
	$check_cat= mysqli_query($db, "SELECT c_name FROM ngo_category where c_name = '".$_POST['c_name']."' ");
	...
	$mql = "INSERT INTO ngo_category(c_name) VALUES('".$_POST['c_name']."')";
	mysqli_query($db, $mql);
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">NGOs</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="allNGOs.php">All Organizations</a></li>
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Organizations Categories</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											...
											<?php
												$sql="SELECT * FROM ngo_category order by c_id desc";
