...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>YUMMY Food Restaurants</title> 
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container">
				<a class="navbar-brand" href="index.php">
					<img src="images/logo2.png" style="width:100px; height:70px;">YUMMY Food Restaurants
				</a>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					...
					<a href="https://html.design/">bhargav</a></p>
					</div>
				</div>
			</div>
		</div>
